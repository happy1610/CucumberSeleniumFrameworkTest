...
public class Hook {
    ...
    public void afterEveryStep(Scenario scenario) {
        try {
            ...
            String fullScreenshot = com.assertthat.selenium_shutterbug.core.Shutterbug.shootPage(driver.get(), com.assertthat.selenium_shutterbug.core.Capture.FULL)
                    .withName("screenshot_" + currentStepIndex.get())
                    .base64();
